# Learning Bash Commadns

The Bandit wargame will teach the basics of the linux command line (Bash) and how to play other wargames.

# Link

* [Play the Bandit Game](http://overthewire.org/wargames/bandit/)
